...
| `49_Node_UI.js` | Node.js | Built-in `readline` module | `node 08_chapter_UserInputs/49_Node_UI.js` |
| `50_Prompt.js` | Node.js | `prompt-sync` package | Install `prompt-sync`, then run the file |
| `51_Fs.js` | Node.js | `fs.readFileSync(0, "utf8")` | `node 08_chapter_UserInputs/51_Fs.js` |
